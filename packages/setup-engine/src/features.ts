...
export const FEATURES: FeatureManifest[] = [
  ...
  },
  {
    ...
    label: "Agent tooling",
    description:
      "Cursor/Claude skills, AGENTS.md, and AI-driven development workflow",
    defaultEnabled: true,
    kind: "subtract",
  ...
  },
  {
    ...
    label: "Storybook",
    description:
      "Component stories with Vitest browser tests, a11y, docs, and Chromatic",
    defaultEnabled: false,
    kind: "add",
    addonPaths: [
      ".storybook",
  ...
  },
  {
    ...
    label: "Infisical",
    description:
      "Secret management — CLI injects env vars for local dev scripts",
    defaultEnabled: false,
    kind: "add",
...
export function getDefaultSelections(): Record<string, boolean> {
